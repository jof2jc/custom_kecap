...
def _execute(filters, additional_table_columns=None, additional_query_columns=None):
	...
	for inv in invoice_list:
		...
		row = [
			inv.name, inv.posting_date, inv.customer, inv.customer_name, inv.sales_person
		]
...
def get_columns(invoice_list, additional_table_columns):
	...
	columns = [
		...
		_("Customer") + ":Link/Customer:120", _("Customer Name") + "::120", _("Sales Person") + ":Link/Sales Person:100"
	]
...
def get_invoices(filters, additional_query_columns):
	...
	return frappe.db.sql("""select name, posting_date, sales_person, debit_to, project, customer, customer_name, owner, remarks,
